    ...
    public function actionSetLoad() { //need to upload image
        ...
        */
        ...
        if (1) {
			...
			$message=$custInfo->fullname."(".$custInfo->idprefix." ".$custInfo->mobile.") Interested In Load ".$gpsalertInfo->source." ".$gpsalertInfo->destination." for ".$gpsalertInfo->date_required." price :".$price;
			$this->sendMail(array("subject"=>$message,"message"=>$message));
...
vehicleModel,lookingForLoad,lookingForLoadDate,fitnessExpire,insuranceExpire,rcNo,NPAvailable,NPExpire,insuranceAmount FROM Device HAVING distance < ".$radius." ORDER BY distance";    

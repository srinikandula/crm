...
class Truck extends CActiveRecord
{
	...
	public function rules()
	{
		return array(
			...
			array('idprefix,description,source_address,source_city,source_state,source_lat,source_lng,fullname,title,front_pic,back_pic,left_pic,right,top_pic,vehicle_insurance,fitness_certificate,vehicle_rc,fitness_certificate_expiry_date,vehicle_insurance_expiry_date','safe'),	
    ...
    public function search()
	{
		...
		$criteria->select="t.fitness_certificate_expiry_date,t.vehicle_insurance_expiry_date,t.vehicle_insurance,t.fitness_certificate,t.vehicle_rc,c.fullname,c.idprefix,c.type,t.id_truck,t.id_customer,t.truck_reg_no,t.tracking_available,t.status,t.approved,tt.title";

...
class AdminRole extends CActiveRecord
{
	...
	public function rules()
	{
		return array(
			...
			array('id_franchise, date_added, date_modified,status', 'safe'),
	...
	public function getAdminRole(){
			...
			if((int)$_SESSION['id_franchise']==1){
				$cond='id_franchise="'.(int)$_SESSION['id_franchise'].'"';
			}else if((int)$_SESSION['id_franchise']!=1 && $_SESSION['id_admin_role']==2){
				$cond='id_admin_role="2" or id_franchise="'.$_SESSION['id_franchise'].'"';
			}else {
				$cond='id_admin_role="'.$_SESSION['id_admin_role'].'"';
			}	

...
class GpsAccount extends GpsActiveRecord
{
	...
	public function rules()
	{
		return array(
            ...
            array('privateLabelName,contactAddress,displayName,distanceUnits,temperatureUnits,vehicleType,contactEmail,smsEnabled,speedUnits','safe'),
        ...
        public function search()
	{
		...
		$criteria->compare('accountID',$this->accountID,true);
				...
				$criteria->addCondition('(accountID!="demo" and accountID!="sysadmin")');

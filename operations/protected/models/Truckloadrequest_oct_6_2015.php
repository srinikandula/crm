...
class Truckloadrequest extends CActiveRecord
{
	...
	public function rules()
	{
		return array(
			...
			array('idprefix,destination_city,destination_address,truck_type,date_created,mobile,truck_reg_no,fullname,date_available,expected_return,status,make_year,make_month,price,source_state,source_city,source_address,title,add_info,source_lat,source_lng','safe'),
			);
	}
	...
	public function searchLoad()
	{
		...
		$criteria=new CDbCriteria;
		$criteria->select="tlrd.destination_city,tlrd.destination_address,tlrd.price,c.idprefix, c.type,c.fullname,c.mobile,t.*,tt.title as truck_type,gt.title as goods_type";

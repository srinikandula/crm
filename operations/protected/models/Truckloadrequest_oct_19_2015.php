...
class Truckloadrequest extends CActiveRecord
{
	...
	public function rules()
	{
		return array(
			...
			array('idprefix,destination_address,truck_type,date_created,mobile,truck_reg_no,fullname,date_available,expected_return,status,make_year,make_month,price,source_state,source_city,source_address,title,add_info,source_lat,source_lng','safe'),
			);
	}

...
class Export {
    ...
    function upload($filename) {
        ...
        chdir($_SERVER['DOCUMENT_ROOT'] . '/operations/osadmin/protected/extensions/library/PHPExcel');
    ...
    // We use the package from http://pear.php.net/package/Spreadsheet_Excel_Writer/
        ...
        chdir($_SERVER['DOCUMENT_ROOT'] . '/operations/osadmin/remove/library/pear');
        ...
        $workbook->setTempDir($_SERVER['DOCUMENT_ROOT'] . '/operations/osadmin/cache');

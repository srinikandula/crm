$(document).ready(function() {
 ...
 // Ajax Cart  
	...
	//		url: 'index.php?route=checkout/cart/update',
			...
			dataType: 'json',
				beforeSend: function() {
 			$('#myCart').after('<span class="wait">&nbsp;<img src="'+HTTP_SERVER+'/application/views/scripts/templates/javascript/images/loading.gif" alt="" /></span>');
		},
			complete: function() {
 			$('.wait').remove();
		},
...
function fnsearch()
{
	window.location.href=HTTP_SERVER+"product/search/q/"+document.getElementById('q').value+"/dd/"+document.getElementById('dd').value
}

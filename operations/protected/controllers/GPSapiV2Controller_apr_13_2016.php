...
vehicleModel,lookingForLoad FROM Device HAVING distance < ".$radius." ORDER BY distance";    
...
vehicleModel,lookingForLoad from Device where deviceID in (select deviceID from AttachedDevice) order by lastValidSpeedKPH desc";                        
...
vehicleModel,lookingForLoad from Device where accountID = '".$account_id."'  order by lastValidSpeedKPH desc";
                }
	...
	public function getNotifytransporteravailabletrucks($tid){
        ...
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV1/logoutDevice
          method=post
          params=userName
          status=0,1
          1:success

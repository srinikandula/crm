...
class TruckController extends Controller {
    ...
    public function actionCreate() {
        ...
        //echo '<pre>';print_r($model['tt']);exit;
    ...
    public function actionUpdate($id) {
        ...
        //echo '<pre>';print_r($model['ctap'][0]->id_truck_attachment_policy);exit;
        if (isset($_POST['Truck'])) {
            $model['t']->attributes = $_POST['Truck'];
//echo '<pre>';print_r($model['t']->attributes);exit;
          $model['t']['mileage'] = $_POST['Truck']['mileage'];
          $model['t']['id_truck_type'] = $_POST['Truck']['id_truck_type'];
        $ml = $model['t']['mileage'];
        $tt = $model['t']['id_truck_type'];
        //$truck=Trucktype::model()->findAll('mileage','id_truck_type='.$tt);
    ...
    public function actionDelete() {//($id)
        ...
        if (sizeof($arrayRowId) > 0) {
            ...
            $criteria->addInCondition('id_truck', $arrayRowId);
...
*/
    public function actionIndex() {
        ...
        //$model['ctap'] = new Truckattachmentpolicy;
    ...
    public function loadModel($id) {
        ...
        //$truck=Trucktype::model()->findAll('id_truck_type='.$tt);
        if ($model === null)
    ...
    protected function grid($data, $row, $dataColumn) {
        switch ($dataColumn->name) {
			...
			case 'fullname':
                ...
                break;
            case 'id_truck_attachment_policy':
                $truck=Truckattachmentpolicy::model()->findAll(array('select'=>'title','condition'=>'id_truck_attachment_policy =' .$data->id_truck_attachment_policy));  
                //echo '<pre>';print_r($truck[0]['title']);exit;
               return $data->id_truck_attachment_policy = $truck[0]['title'];

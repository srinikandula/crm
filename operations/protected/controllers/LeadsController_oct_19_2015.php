...
class LeadsController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (Yii::app()->request->isPostRequest) {
            ...
            if ($model['c']->validate()) {
               ...
               //echo '<pre>';print_r($model['c']->date_created);exit;
    ...
    public function imagePopup($file){
		echo '<div id="image-name-display-id">'.$file.'<div class="logo-img"><img src="'.Library::getTruckUploadLink() . $file.'"></div></div>';
    }
	...
	$model['cvt']=CHtml::listData(Customervechiletypes::model()->findAll('id_customer="'.(int)$_GET['id'].'"'),'id_truck_type','title');
        ...
        //echo '<pre>';print_r($model['dr']);echo '</pre>';exit;

...
class GPSapiV2Controller extends Controller {
    ...
    /*public function actionGetAlerts() { //need to upload image
          ...
          //http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/GetAlerts
          //method=get
        ...
        if (1) {
			...
			foreach($rows as $row){
				$json['data'][] = array("id_goods_type"=>$row[id_goods_type]==""?"":$row[id_goods_type],
					...
					"source"=>$row[source]==""?"":str_replace(", India","",$row[source]),
					"destination"=>$row[destination]==""?"":str_replace(", India","",$row[destination]),
	...
	public function actionSetTruckInfo() { //need to upload image
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/SetTruckInfo
          method=post
    ...
    public function actionSetTruckInfoApril272016() { //need to upload image
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/SetTruckInfo
          method=post
          params=accountid,address,truck_reg_no,date_available,mobile
        ...
        */
		...
		if(1){
			...
			$custInfo=$this->getCustomer($uid);
			$message=$custInfo->fullname."(".$custInfo->idprefix." ".$mobile.") updated Truck Avail Location ".$truck_reg_no." to  ".$address." date: ".$date_available;
			$this->sendMail(array("subject"=>$message,"message"=>$message));
        }
        echo CJSON::encode($json);
        Yii::app()->end();
    ...
    public function actionGetTrucks() { //need to upload image
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/GetTrucks
          method=post
          params=accountid
         modified
         uid
    ...
    public function actionLogin() {
        ...
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/Login
          method=post
	...
	public function actionSetTruck() { 
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/SetTruck
          method=post
    ...
    public function actionSetCustomer() { //need to upload image
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/SetCustomer
          method=post
    ...
    public function actionSetLoad() { //need to upload image
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/SetLoad
          method=post
	...
	public function actionisUserActive1(){
		/*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/isUserActive
          method=post
          params=username,uid
          status=0,1
          1:success
    ...
    public function actionGetOrders() { 
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/GetOrders
          method=post
        ...
        */
        ...
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/SetPostLoad
          method=post
    ...
    public function actionGetPostLoads() { 
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/GetPostLoads
          method=post
          params=uid,offset
        */
        ...
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/GetQuotes
          method=post
          params=lid
        */
	...
	public function actionselectLoadQuote() { 
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/selectLoadQuote
          method=post
          params=qid
        */
    ...
    public function actionselectTrucksAvailable() { 
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/selectTrucksAvailable
          method=post
         uid,tid
        */
	...
	/*
        http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/DeleteTruck
        method=post
        tid
        */
	...
	/*
        http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/CancelPostedLoad
        method=post
        lid
        */
	...
	public function actiongetTrucksAvailable1() { 
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/getTrucksAvailable
          method=post
        */
	...
	public function actionBookTrucksAvailable() { //need to upload image
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/BookTrucksAvailable
          method=post
	...
	public function actionTrackOrderedTruck() { 
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/TrackOrderedTruck
          method=post
          params=uid,oid
         modified
         uid
...
DAY ) as unx_date_ordered_3  from eg_order where id_order='".$oid."'")->queryRow();
        ...
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/forgotpassword
          method=post
          params=userName
          status=0,1
          1:success
	...
	public function actiontrackallvehiclesolddec1() { //need to upload image
        /*
        ...
        */
            ...
            if($account_id!=""){
				...
				//if($account_id=="egmumbai"){
                    ...
                    $query="SELECT (select concat(contactName,',',contactPhone) from Account where Account.accountID=Device.accountID) as contact, deviceID as truck_no,deviceID,ifnull(lastValidLatitude,0) as latitude,ifnull(lastValidLongitude,0) as longitude,concat(ceil(lastValidSpeedKPH*1.852),' ','Km/Hr') as speed, (ifnull(lastUpdateTime,0)+19800) as time_in_secs,FROM_UNIXTIME(ifnull(lastUpdateTime,0), '%d-%m-%y %H:%i') as date_time,concat(ceil(lastOdometerKM),' ','Km') as odometer, ( 3959 * acos( cos( radians(".$pointLat.") ) * cos( radians(lastValidLatitude) ) * cos( radians(lastValidLongitude) - radians(".$pointLng.") ) + sin( radians(".$pointLat.") ) * sin( radians(lastValidLatitude) ) ) ) AS distance,vehicleType,
vehicleModel,lookingForLoad,lookingForLoadDate,fitnessExpire,insuranceExpire,rcNo,NPAvailable,NPExpire,insuranceAmount FROM Device where isActive=1 and lastGPSTimestamp>".$duetime." HAVING  distance < ".$radius." ORDER BY distance limit 5";    

                }else if($account_id=="egattached"){
						$query = "select (select concat(contactName,',',contactPhone) from Account where Account.accountID=Device.accountID) as contact,deviceID as truck_no,deviceID,lastValidLatitude as latitude,lastValidLongitude as longitude,concat(ceil(lastValidSpeedKPH*1.852),' ','Km/Hr') as speed, (ifnull(lastUpdateTime,0)+19800) as time_in_secs,FROM_UNIXTIME(ifnull(lastUpdateTime,0), '%d-%m-%y %H:%i') as date_time,concat(ceil(ifnull(lastOdometerKM,0)),' ','Km') as odometer,vehicleType,
vehicleModel,lookingForLoad,lookingForLoadDate,fitnessExpire,insuranceExpire,rcNo,NPAvailable,NPExpire,insuranceAmount from Device where deviceID in (select deviceID from AttachedDevice) order by lastValidSpeedKPH desc";                        
						...
						$query = "select deviceID as truck_no,deviceID,ifnull(lastValidLatitude,0) as latitude,ifnull(lastValidLongitude,0) as longitude,concat(ceil(lastValidSpeedKPH*1.852),' ','Km/Hr') as speed, (ifnull(lastUpdateTime,0)+19800) as time_in_secs,FROM_UNIXTIME(ifnull(lastUpdateTime,0), '%d-%m-%y %H:%i') as date_time,concat(ceil(ifnull(lastOdometerKM,0)),' ','Km') as odometer,vehicleType,
vehicleModel,lookingForLoad,lookingForLoadDate,fitnessExpire,insuranceExpire,rcNo,NPAvailable,NPExpire,insuranceAmount from Device where accountID = '".$account_id."'  order by lastValidSpeedKPH desc";
                }
...
vehicleModel,lookingForLoad,lookingForLoadDate,fitnessExpire,insuranceExpire,rcNo,NPAvailable,NPExpire,insuranceAmount from Device where  isActive=1 and ".$srchQry." accountID = '".$account_id."'  order by lastValidSpeedKPH desc";
                ...
                if(is_array($rows) && sizeof($rows)){
					...
					$i=0;
					$date=date('Y-m-d');
					//$damageTime=strtotime('now')+19800-10800; //3hours
					//$currentTime=strtotime('now')+19800;
					...
					foreach($rows as $row){
						...
						if($row['time_in_secs']<$damageTime){
							$success[$i]['damage']="1";
						}else if($account_id=='ayyappacargo' && $row['creationTime']+10800<$currentTime ){
							if(!$row['speedValue']){
								//if(1){
	...
	public function actiontracktruck() { //need to upload image
			/*
			  http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/tracktruck
			  method=post
			  truckregno
			  from
			  to
...
$points[$loop]['speedValue']=ceil($rows[$i-1]['speedKPH']);
	...
	public function actiontracktruckMay32016() { //need to upload image
			/*
			  http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/tracktruck
			  method=post
			  truckregno
				...
				foreach($rows as $row)
				{
					if($row['speedKPH']){
						...
						$points[$loop]['speedValue']=ceil($row['speedKPH']);
                                            ...
                                            if($prevTimestamp!="")
                                            {
                                                $distance=(int)$this->distance($row['latitude'], $row['longitude'], $prevLat, $prevLng, "K");
                                                $stopTime+=$row['time_in_secs']-$prevTimestamp;
                                            }
                                            
                                            $prevLat=$row['latitude'];
                                            $prevLng=$row['longitude'];
                                            $prevTimestamp=$row['time_in_secs'];
                                            $stops[$stopLoop]=array("latitude"=>$row['latitude'],"longitude"=>$row['longitude'],"date_time"=>$row['date_time'],"time_in_secs"=>$row['time_in_secs']-$stopTime,"stopTime"=>$stopTime,"distance"=>$distance);
                                            if($distance){
                                                $distance=0;
                                                $stopTime=0;
                                                $prevLat="";
                                            ...
                                            /*if($row['time_in_secs'] <$lastStopTime+$stopDuration){
                                                continue;
                                            }
                                                
						$stops[]=array("latitude"=>$row['latitude'],"longitude"=>$row['longitude'],"date_time"=>$row['date_time'],"time_in_secs"=>$row['time_in_secs']);
                                                $lastStopTime=$row['time_in_secs'];*/
					}
...
public function distance($lat1, $lon1, $lat2, $lon2, $unit) {
  ...
  if ($unit == "K") {
	...
	public function actiontracktruckapril272016() { //need to upload image
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/tracktruck
          method=post
		  truckregno
        ...
        */
            ...
            if($truckregno!="" && $from!="" && $to!=""){
				...
				if(is_array($rows) && sizeof($rows)){
                    $json['statusCode']=1;
					//$json['success']['odokm']=ceil($info[max_odokm]-$info[min_odokm])." Km";
					$json['success']['odokm']=ceil($info[max_odokm])." Km";
					$json['success']['from']=$from;
					$json['success']['to']=$to;
					$json['success']['diff']=$too-$fromm;
					$json['success']['idleTime']=$idleTime." Hours";
	...
	public function getNotifytransporteravailabletrucks($tid){
        ...
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/logoutDevice
          method=post
          params=userName
          status=0,1
          1:success
	...
	public function actionUploadSellTruck(){
		...
		//http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/UploadSellTruck?id_sell_truck=1&field=truck_front_pic
	...
	public function actionaddSellTruck(){
		...
		/*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/addSellTruck?uid=1&truck_reg_no=ap36k7271&contact_name=hello&contact_mobile=998877
          method=post
          params=username,uid
          status=0,1
          1:success
	...
	public function actionGetSellTrucks() { 
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/GetSellTrucks?uid=1&accountid=santosh&offset=0
          method=post
	...
	public function actionGetSellTruckPics() { 
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/GetSellTruckPics?id_sell_truck=1
          method=post
	...
	public function actionApplySellTruck() { 
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/ApplySellTruck?uid=1&accountid=santosh&id_sell_truck=1&expected_price=1000
          method=post
	...
	public function actionsetDeviceLoad() { 
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/setDeviceLoad?uid=1&cname=santosh&mobile=9988776655&deviceid=AP36k7271&lookingforload=1&address=address&vehicleModel=21 ton
          method=post
        */
	...
	$data['lookingforload'] =(int)$_REQUEST['lookingforload'];
        ...
        echo CJSON::encode($json);
        if($data['lookingforload']){ $this->sendPushNotification(array("message"=>$message));}
		Yii::app()->end();
    }

	public function actionsetDeviceLoadApr272016() { 
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/setDeviceLoad?uid=1&cname=santosh&mobile=9988776655&deviceid=AP36k7271&lookingforload=1&address=address&vehicleModel=21 ton
          method=post
        ...
        */
		...
		//if (Yii::app()->request->isPostRequest) {
		if (1) {
			GpsDevice::model()->updateAll(array("lookingForLoad"=>$data['lookingforload']),"lower(deviceID) like '".strtolower($data['deviceid'])."'");
			if($data['lookingforload']){
				$message="Looking for Load:Truck No ".$data['deviceid']." (".$data['truck_type'].") of ".$data['cname'].",".$data['mobile']." located at ".$data['address'];	
			}else{
				$message="Not Looking for Load:Truck No ".$data['deviceid']." (".$data['truck_type'].") of ".$data['cname'].",".$data['mobile']." located at ".$data['address'];
	...
	public function actionsetDeviceDetails(){
	    /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/setDeviceDetails
          method=post
	...
	public function actionrepost(){
		/*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/repost
          method=post
	...
	public function actiongetPostLoadDetails(){
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/getPostLoadDetails?id_load_truck_request=
          method=post
...
public function actiongetLoyalityPointsInfo(){
    /*
     http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/getLoyalityPointsInfo?uid=1
     method=post
    */
        $uid=(int)$_REQUEST['uid'];
        $json = array("status" => 0);
	...
	public function actiongetLoyalityPointsInfoApr292016(){
    /*
     http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/getLoyalityPointsInfo?uid=1
     method=post
    */
    ...
    /*
     egcrm.cloudapp.net/operations/index.php/GPSapiV2/redeemPoints?uid=2&lid=1&points=600
     method=post
    ...
    */
	...
	/*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/createTrip
          method=post
	...
	/*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/getTripList
          method=post
        ...
        */
        ...
        if (Yii::app()->request->isPostRequest) {
			...
			$srchQry="";
            if($trip['q']!=""){ $srchQry="deviceID like '%".$trip['q']."%' and "; }
	...
	public function actiongetTripSummary(){
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/getTripSummary
          method=post
          params=Trip[id]
        */
        $trip=$_POST['Trip'];
	...
	public function actiondeleteTrip(){
		/*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/deleteTrip
          method=post
	...
	/*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/stopTrip
          method=post
	...
	public function actiongetGroupList(){
		/*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/getGroupList
          method=post
          params=account_id
        */
        ...
        if($accountID!=""){
            $rows=Yii::app()->db_gts->createCommand("select groupID,displayName from DeviceGroup where accountID='".$accountID."'")->queryAll();
            $json['redirect']=1;
            $json['data'][]=array("id"=>"0","groupname"=>"All");
            foreach($rows as $row){
                $json['redirect']=0;
                $json['data'][]=array("id"=>$row['groupID'],"groupname"=>$row['displayName']);
            }
	...
	public function actionSetPassword() { //need to upload image
        /*
          http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/SetPassword
          method=post
	...
	/*
	  http://egcrm.cloudapp.net/operations/index.php/GPSapiV2/Trial
	  method=post
	  params=account_id
	*/

...
class LoadrequestController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (Yii::app()->request->isPostRequest && sizeof($_POST['Truck'])) {
            ...
            foreach ($_POST['Truck'] as $data) {
                ...
                $this->addDestinations(array('id'=>$id_truck_load_request,'dest'=>$data['destination_address']));
            }
    ...
    public function actionUpdate($id) {
        ...
        $destRow=Truckloadrequestdestinations::model()->find(array('select'=>'GROUP_CONCAT(destination_city) AS destination_city','condition'=>'id_truck_load_request="'.$id.'"'));
        ...
        if (Yii::app()->request->isPostRequest) {
            ...
            //echo '<pre>';print_r($dests);print_r($model['t']->attributes);print_r($_POST);exit;
                ...
                $this->addDestinations(array('id'=>$id,'dest'=>$_POST['Truckloadrequest']['title']));

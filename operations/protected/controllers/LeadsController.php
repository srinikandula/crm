...
class LeadsController extends Controller {
    ...
    public function actioncheckunique(){
        ...
        if (Yii::app()->request->getIsAjaxRequest() && Yii::app()->request->isPostRequest) {
           $obj=Customer::model()->find(array('select'=>'islead,fullname,mobile,type','condition'=>'type!="G"  and mobile="'.$mobile.'"'));
           if($obj->mobile!=""){
            $status=0;
			$lead=$obj->islead?"Lead":"Registered";
            $msg="Mobile already exist!!".$obj->fullname." , ".$obj->type.",".$lead;
           }else{
            $status=1;    
           }
    ...
    public function actionCreate() {
        ...
        if (Yii::app()->request->isPostRequest) {
            ...
            $model['c']->id_franchise=$_SESSION['id_franchise'];
    ...
    public function actionIndex() {
        //exit("value of ".$_SESSION['id_franchise']);

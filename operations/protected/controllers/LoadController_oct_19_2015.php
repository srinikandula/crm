...
class LoadController extends Controller {
    ...
    public function accessRules() {
        return $this->addActions(array('Sendordersms','Addorder','Approve', 'Addquote', 'Addcomment', 'searchResults','bookrequest','deletequote'));
    }
    ...
    public function actionUpdate($id) {
        ...
        if(Yii::app()->request->isPostRequest && $_SESSION['id_admin_role']==8){
            ...
            if($modified_fields!=0){ $model['ltr']->modified_fields =$modified_fields; }

        ...
        */
        ...
        if (1) {
            ...
            foreach($accRows as $accRow){
                ...
                $this->sendSms($accRow['contactPhone'],$msg);
                //echo $msg." <br/>";
            }
	...
	public function actionPeriodicDeviceCheckUp(){
        ...
        if(sizeof($rows)){
            ...
            if($message!=""){
				...
				$headers .= 'From: <info@easygaadi.com>' . "\r\n";
                mail("arjun@easygaadi.com,suresh@easygaadi.com,raviroy.easygaadi@gmail.com","GPS Device Down - ".date('Y-m-d_h:i:sa'),$message,$headers);
            }
        }
	...
	<td>
		<table border="1">
                ...
                if (sizeof($lbillingRows)) {
                    ...
                    $txt.='<tr style="color:red;font-weight:bold;"><td colspan="2">No Billing Details</td></tr>';
                }

                $txt.='<tr><td colspan="2"><b>Load Trans</b></td></tr>';
                ...
                if (sizeof($ltranRows)) {
                    ...
                    $txt.='<tr style="color:red;font-weight:bold;"><td colspan="2">No Trans Details</td></tr>';
                }
		...
		<table border="1">
                ...
                $txt.='<tr><td colspan="2"><b>Truck Trans</b></td></tr>';

...
class OrderController extends Controller {
    ...
    public function accessRules() {
        return $this->addActions(array('updateFields','payAmountTransaction','deleterow','updateStatus', 'updateAmount', 'modifyTruck', 'payAmount','addOrder','Addlocation','deletelocation'));
    }
    ...
    public function actionUpdate($id) {
        ...
        if (Yii::app()->request->isPostRequest) {
            ...
            $model['0']->customer_fullname = $_POST['Order']['customer_fullname'];
            $model['0']->customer_mobile = $_POST['Order']['customer_mobile'];
            $model['0']->orderperson_fullname = $_POST['Order']['orderperson_fullname'];
            ...
            //echo '<pre>';print_r($model['0']->orderperson_fullname);exit;
            if($model['0']->save())
    ...
    public function actionIndex() {
       ...
       //echo '<pre>';print_r($orderStatusRows);exit;
        $this->render('index', array('orderStatus'=>$orderStatusRows,

...
class Library
{
	...
	public function getCustomerDocTypes(){
		return array('Driving Licence'=>'Driving Licence','Voter Card'=>'Voter Card','Adhaar Card'=>'Adhaar Card','Ration Card'=>'Ration Card','Electricity Bill'=>'Electricity Bill','Bank Pass Book'=>'Bank Pass Book');
	}
}
...
class Mail {
    ...
    public static function send($data = array()) {
        ...
        if (isset($data['mail']['from'])) {
            ...
            $from['name'] = Yii::app()->config->getData('CONFIG_SITE_NAME');
            $from['email'] = Yii::app()->config->getData('CONFIG_SITE_SUPPORT_EMAIL_ADDRESS');
        }
        ...
        if (isset($data['mail']['reply'])) {
            ...
            $reply['name'] = Yii::app()->config->getData('CONFIG_SITE_NAME');
            $reply['email'] = Yii::app()->config->getData('CONFIG_SITE_REPLY_EMAIL');
        }

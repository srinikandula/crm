...
class Library
{
	...
	public function getLeadStatuses(){
		return array('Initiated'=>'Initiated','Attempted to Contact'=>'Attempted to Contact','Cold'=>'Cold','Contact in Future'=>'Contact in Future','Contacted'=>'Contacted','Hot'=>'Hot','Junk Lead'=>'Junk Lead','Lost Lead'=>'Lost Lead','Not Contacted'=>'Not Contacted','Pre Qualified'=>'Pre Qualified','Qualified'=>'Qualified','Warm'=>'Warm','Request For Approval'=>'Request For Approval');
	}
	...
	public function getBookingComments(){
		return array("Booked Amount"=>"Booked Amount","Goods Damage"=>"Goods Damage","Loading Charges"=>"Loading Charges","Unloading Charges"=>"Unloading Charges","Waiting Charges"=>"Waiting Charges","Theft"=>"Theft","Overload Charge"=>"Overload Charge","Others"=>"Others");
	}
	...
	public function getGPBYLATLNGDetailsForMobile($latlng){
		...
		//$details_url="https://maps.googleapis.com/maps/api/geocode/json?latlng=".urlencode($latlng)."&sensor=false&key=AIzaSyDjXGtInKkbAXKR-WkzTsB-DftN_mCctd8";//mahindra.mj@gmail.com

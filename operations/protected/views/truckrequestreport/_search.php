...
<script>
function fnsubmit(){
    var addr='Loadtruckrequest[date_created_from]='+$("#date_created_from").val()+'&Loadtruckrequest[date_created_to]='+$("#date_created_to").val()+'&Loadtruckrequest[source_address]='+$("#source_address").val()+'&Loadtruckrequest[destination_address]='+$("#destination_address").val()+'&Loadtruckrequest[status]='+$("#Loadtruckrequest_status").val()+'&Loadtruckrequest[group_by]='+$("#Loadtruckrequest_group_by").val()+'&Loadtruckrequest[id_truck_type]='+$("#Loadtruckrequest_id_truck_type").val();

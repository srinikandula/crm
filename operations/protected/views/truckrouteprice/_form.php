    ...
    <div class="tab-pane active" id="Personal Details">
        <div class="span12 ">
            <fieldset class="portlet" >
                ...
                <?php if($_GET['id']==""){?>
                    <div class="span5">  <?php echo $form->textFieldRow($model['trp'], 'id_truck', array("onkeydown"=>"fnKeyDown('Truckrouteprice_id_truck')",'rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)); ?> </div>
                    <?php }?>

				        <div class="span5">  <?php
                        echo $form->textFieldRow(
                                $model['trp'], 'source_address', array('rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)
                        );
                        ?></div>

						<div class="span5">  <?php
                        echo $form->textFieldRow(
                                $model['trp'], 'destination_address', array('rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)
                        );
                        ?></div>
          ...
          'maxlength'=>45,
                    ...
                    <div class="span5">   <?php 
                           echo $form->datepickerRow(
                                $model['trp'], 'date_available', array(

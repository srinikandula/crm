    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'release_truck', 'header' => 'Release Truck',
                    'filter' => CHtml::dropDownList('Orderstatus[release_truck]',
                            $_GET['Orderstatus']['release_truck'],
                            array('' => 'All', '1' => 'Yes', '0' => 'No',)
                    ), 'value' => '$data->release_truck==1?"Yes":"No"'),
				array('name' => 'status', 'header' => 'Status',
                    'filter' => CHtml::dropDownList('Orderstatus[status]',
                            $_GET['Orderstatus']['status'],

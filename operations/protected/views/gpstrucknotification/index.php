    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'no_of_trucks', 'header' => 'No Of Trucks', 'value' => '$data->no_of_trucks','filter'=>false),
		...
		array('name' => 'sendtoall', 'header' => 'Send To',
				
                    'filter' => CHtml::dropDownList('Gpsalerts[sendtoall]',
                            $_GET['Gpaalerts']['sendtoall'],
                            array('' => 'All', '1' => 'Yes', '0' => 'No',)
                    ), 'value' => '$data->sendtoall==1?"Yes":"No"'),

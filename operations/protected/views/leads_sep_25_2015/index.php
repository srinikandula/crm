...
<div class="span12 top_box_fixed">
    ...
    <div class="row-fluid grid-menus span12 pull-left ">
        <div class="span12">
            ...
            <?php if($this->addPerm){?>
            <div><input  type="file" name="import"><input  type="submit" class="btn btn-info" name="submit" value="Import Excel" ></div>
            <div ><a  href="<?php echo Yii::app()->params['config']['admin_url']."customer_lead.xlsx";?>"><div class="btn btn-info">Download Excel</div></a></div><?php }?>
            <div class="span2 dropdown_cut_main pull-right" style="margin-top:-40px">
                <div class="span7 pull-right">
                    <?php Library::getPageList(array('totalItemCount' => $model->searchCustomerLead()->totalItemCount)); ?>
                </div>
            </div>
        </div>
    </div>
...
$this->widget('bootstrap.widgets.TbExtendedGridView', array(
	...
	'ajaxUpdate'=>false,
	'id'=>'productinfo-grid',
	'dataProvider'=>$model->searchCustomerLead(),
	'filter'=>$model,
        'bulkActions' => array(
                'actionButtons' => array(

...
<?php echo $form->errorSummary($model['trp']); ?>
...
$this->widget(
    ...
    array(
        'type' => 'pills', 
        'tabs' => array(
            array( 'label' => 'Route Price', 'active' => true ,  'content' => $this->renderPartial('_form', array('form'=>$form,'model'=>$model),true)),
            array( 'label' => 'Truck', 'content' => $this->renderPartial('_truck', array('form'=>$form,'model'=>$model),true)),

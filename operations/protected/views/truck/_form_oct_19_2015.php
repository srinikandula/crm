			...
			echo $form->dropDownListRow($model['t'], 'id_truck_type', $list); ?>
                ...
                <div class="span5">   <?php 
                        ...
                        echo $form->fileFieldRow(
                            ...
                            'data-toggle' => "tooltip", 'data-placement' => "right",
                            'class' => 'Options_design'),
                                array('hint' => '<div class="logo-img"><img src="' . Library::getTruckUploadLink() . $model['t']->vehicle_rc . '"><input type="hidden" name="prev_vehicle_rc" value="' . $model['t']->vehicle_rc . '"></div>')
                        );
                        echo '<p class="image-name-display">' . $model['t']->vehicle_rc . '</p>';?>
                        </div>
                        ...
                        echo $form->fileFieldRow(
                            ...
                            'data-toggle' => "tooltip", 'data-placement' => "right",
                            'class' => 'Options_design'),
                                array('hint' => '<div class="logo-img"><img src="' . Library::getTruckUploadLink() . $model['t']->front_pic . '"><input type="hidden" name="prev_front_pic" value="' . $model['t']->front_pic . '"></div>')
                        );
                        echo '<p class="image-name-display">' . $model['t']->front_pic . '</p>';?>
                        </div>
                        ...
                        echo $form->fileFieldRow(
                            ...
                            'data-toggle' => "tooltip", 'data-placement' => "right",
                            'class' => 'Options_design'),
                                array('hint' => '<div class="logo-img"><img src="' . Library::getTruckUploadLink() . $model['t']->back_pic . '"><input type="hidden" name="prev_back_pic" value="' . $model['t']->back_pic . '"></div>')
                        );
                        echo '<p class="image-name-display">' . $model['t']->back_pic . '</p>';?>
                        </div>
                        ...
                        echo $form->fileFieldRow(
                            ...
                            'data-toggle' => "tooltip", 'data-placement' => "right",
                            'class' => 'Options_design'),
                                array('hint' => '<div class="logo-img"><img src="' . Library::getTruckUploadLink() . $model['t']->right_pic . '">'
                                    . '<input type="hidden" name="prev_right_pic" value="' . $model['t']->right_pic . '"></div>')
                        );
                        echo '<p class="image-name-display">' . $model['t']->right_pic . '</p>';?>
                        </div>
                        ...
                        echo $form->fileFieldRow(
                            ...
                            'data-toggle' => "tooltip", 'data-placement' => "right",
                            'class' => 'Options_design'),
                                array('hint' => '<div class="logo-img"><img src="' . Library::getTruckUploadLink() . $model['t']->left_pic . '"><input type="hidden" name="prev_left_pic" value="' . $model['t']->left_pic . '"></div>')
                        );
                        echo '<p class="image-name-display" id="asdf">' . $model['t']->left_pic . '</p>';?>
                        </div>
                        ...
                        echo $form->fileFieldRow(
                            ...
                            'data-toggle' => "tooltip", 'data-placement' => "right",
                            'class' => 'Options_design'),
                                array('hint' => '<div class="logo-img"><img src="' . Library::getTruckUploadLink() . $model['t']->top_pic . '"><input type="hidden" name="prev_top_pic" value="' . $model['t']->top_pic . '"></div>')
                        );
                        echo '<p class="image-name-display">' . $model['t']->top_pic . '</p>';?>
                        </div>

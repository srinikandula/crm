			...
			echo $form->dropDownListRow($model['t'], 'id_truck_type', $list); ?>
				...
				echo CHtml::dropdownlist('Truck[make_month]', $model['t']->make_month, Library::getMakeMonths(),array('prompt'=>'Month'));?>
                    ...
                    ?>
                                   ...
                                   <?php if(($model['t']->tracking_available == 1)||($model['t']->tracking_available == "")){ ?>
						<div class="span5 gps_fields">
                            <?php echo $form->textFieldRow($model['t'], 'gps_imei_no', array('rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)); ?>
                        </div>
						<div class="span5 gps_fields">
                            <?php echo $form->textFieldRow($model['t'], 'gps_mobile_no', array('rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)); ?>
                                   </div> <?php } else { ?>
						<div class="span5 gps_fields" style="display:none">
                            <?php echo $form->textFieldRow($model['t'], 'gps_imei_no', array('rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)); ?>
                        </div>
						<div class="span5 gps_fields" style="display:none">
                            <?php echo $form->textFieldRow($model['t'], 'gps_mobile_no', array('rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)); ?>
                ...
                <div class="span5">
                    <?php echo $form->textFieldRow( $model['t'], 'chasis_no',  array('rel' => 'tooltip','data-toggle' => "tooltip", 'data-placement' => "right",));
                        ?>
                </div>
                <div class="span5">
                    <?php echo $form->textFieldRow( $model['t'], 'engine_no',  array('rel' => 'tooltip','data-toggle' => "tooltip", 'data-placement' => "right",));
                        ?>
                </div>
				...
				<div class="span5">
                    <?php echo $form->textFieldRow( $model['t'], 'rc_no',  array('rel' => 'tooltip','data-toggle' => "tooltip", 'data-placement' => "right",));
                        ?>
                </div>

				<div class="span5">
                            <?php echo $form->radioButtonListRow($model['t'], 'national_permit_available',
                            array('1' => 'Yes', '0' => 'No'));
                    ?>
                </div>
				...
				<div class="span5">   <?php 
                           echo $form->datepickerRow(
                                $model['t'], 'national_permit_expiry_date', array(
                            'options' => array('dateFormat' => 'yy-mm-dd',
                            'altFormat' => 'dd-mm-yy',
                            'changeMonth' => 'true',
                            'changeYear' => 'true',
				...
				<div class="span5">
                    <?php echo $form->textFieldRow( $model['t'], 'insurance_amount',  array('rel' => 'tooltip','data-toggle' => "tooltip", 'data-placement' => "right",));
                        ?>
                </div>
                ...
                <div class="span5">
                    <?php echo $form->textFieldRow( $model['t'], 'mileage',  array('rel' => 'tooltip','data-toggle' => "tooltip", 'data-placement' => "right",));
                        ?>
                </div>
...
<script type="text/javascript">
$(document).ready(function(){
    $('input[name="Truck[tracking_available]"]').click(function(){
        if($(this).attr("value")=="1"){
            $(".gps_fields").show();
        }
        if($(this).attr("value")=="0"){
            $(".gps_fields").hide();
            $("#Truck_gps_imei_no,#Truck_gps_mobile_no").val('');
           }

                    ...
                    <tr >
                        ...
                        <td>
                            <input type="text" id="Commission_PersonTruckRoute_<?php echo $row1; ?>_source_city" class="Options_design" data-placement="right" data-toggle="tooltip" rel="tooltip"
                                   name="Commission[PersonTruckRoute][<?php echo $row1; ?>][source_city]" data-original-title="enter commission" value="<?php echo $modelRow->source_city; ?>">
                        </td>
                        <td>
                            <input type="text" id="Commission_PersonTruckRoute_<?php echo $row1; ?>_destination_city" class="Options_design" data-placement="right" data-toggle="tooltip" rel="tooltip"
                                   name="Commission[PersonTruckRoute][<?php echo $row1; ?>][destination_city]" data-original-title="enter commission" value="<?php echo $modelRow->destination_city; ?>">
                        </td>    
...
<script type='text/javascript'>
    ...
    function addCustomerTruckRoute()
    {
        ...
        row += '<td><input type="text"  data-original-title="enter source city" name="Commission[PersonTruckRoute][' + row_no1 + '][source_city]" rel="tooltip" data-toggle="tooltip" data-placement="right" class="Options_design" id="Commission_PersonTruckRoute_' + row_no1 + '_source_city"></td>';
        row += '<td><input type="text"  data-original-title="enter destination city" name="Commission[PersonTruckRoute][' + row_no1 + '][destination_city]" rel="tooltip" data-toggle="tooltip" data-placement="right" class="Options_design" id="Commission_PersonTruckRoute_' + row_no1 + '_destination_city"></td>';

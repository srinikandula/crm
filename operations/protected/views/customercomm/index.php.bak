...
1.customer based,2.truck based,3.Customer truck route based,4.Route based,5.Point based,6.default global commission.if none of the condition is matched then global commission will be applied to the price.</div><div>Here, the given commission will be applied to all the trucks of the selected customer</div>
<?php 
$form = $this->beginWidget(
    ...
    array(
        'id' => 'horizontalForm',
        'type' => 'horizontal',
        'action'=>$this->createUrl('customercomm/update'),

                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" class="middle table">
                                            <tbody>
                                                <tr class="sub-title-div">
                                                    ...
                                                    <td width="12%" align="center" class="admin-role-div"><strong>List All</strong></td>
                                                ...
                                                <tr class="sub-links-div">
                                                    ...
                                                    <td height="22" align="center" class="admin-role-div"><input type="checkbox" <?php echo $subV['file']['listall']!='Y'?'disabled':''; ?>  <?php echo $result[$k][$subV[file][file_name]]['listall']=='Y'?'checked':''; ?>  name="<?php echo 'permissions['.$k.']['.$subV[file][file_name].'][listall]';?>" value="Y"></td>

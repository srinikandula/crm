    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView', array(
            ...
            'columns' => array(
                ...
                array('name' => 'date_created', 'header' => 'Date Created', 'value' => '$data->date_created','filter'=>false),
                array('name' => 'date_modified', 'header' => 'Date Modified', 'value' => '$data->date_modified','filter'=>false),
                array(
                    'name' => 'status', 'header' => 'Status',
                    'filter' => CHtml::dropDownList('Admin[status]', $_GET['Admin']['status'], array('' => 'All', '1' => 'Enable', '0' => 'Disable',)

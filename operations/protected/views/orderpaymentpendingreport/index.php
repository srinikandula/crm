    ...
    <div class="tab-pane active" id="Personal Details"> 
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView', array(
            ...
            'columns' => array(
                ...
                array('name' => 'billing', 'header' => "TR Bill", 'value' => array($this,'grid'),'filter'=>false),
                array('name' => 'transaction', 'header' => "TR Paid", 'value' => array($this,'grid'),'filter'=>false),
                array('name' => 'amount', 'header' => "TR Due", 'value' => '$data[billing]-$data[transaction]','filter'=>false),
                //array('name' => 'trlastpaid', 'header' => "TR Last Paid", 'value' => '$data[trlastpaid]','filter'=>false),
                array('name' => 'tobilling', 'header' => "TO Bill", 'value' => array($this,'grid'),'filter'=>false),
                array('name' => 'totransaction', 'header' => "TO Paid", 'value' => array($this,'grid'),'filter'=>false),
                array('name' => 'amount', 'header' => "TO Due", 'value' => '$data[tobilling]-$data[totransaction]','filter'=>false),
                //array('name' => 'tolastpaid', 'header' => "TO Last Paid", 'value' => '$data[tolastpaid]','filter'=>false),
				array('name' => 'tolastpaid', 'header' => "Net Profilt", 'value' => '$data[billing]-$data[tobilling]','filter'=>false),
				array('name' => 'truck_owner_commission', 'header' => "Commission", 'value' => '$data[truck_owner_commission]','filter'=>false),
            ),
        ));
        ?>

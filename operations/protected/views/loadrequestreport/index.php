    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'id_truck_load_request', 'header' => 'No Of Requests', 'value' => array($this,'grid'),'type'=>'raw'),
            ),
        ));
        ?>
...
<?php if($_GET['data']!="" ){ ?> <div class="span12 top_box_margin" id="request_design"> <?php Yii::app()->runController('loadrequestreport/update/1');?></div>

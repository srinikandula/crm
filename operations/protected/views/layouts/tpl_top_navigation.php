<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-inner">
          ...
          <a class="brand" style="height:20px" href="<?php echo $this->createAbsoluteUrl(array("dashboard","index"));?>" >
              <img src="<?php  echo $baseUrl;?>/img/logo_2.png" alt="" title="" height="34px" width="90" style="margin-top:-6px" /> </a>

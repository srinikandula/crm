	...
	'columns'=>array(
     array(
        ...
        'value'=>'$this->grid->dataProvider->pagination->currentPage * $this->grid->dataProvider->pagination->pageSize + ($row+1)',
				...
				array('name'=>'customer_fullname','header'=>'Customer Name','value'=>'$data->customer_fullname'),
				array('name'=>'customer_mobile','header'=>'Mobile','value'=>'$data->customer_mobile'),
				array('name'=>'customer_email','header'=>'Email','value'=>'$data->customer_email'),
				...
				array('name'=>'customer_type','header'=>'Customer Type',
				'filter'=>CHtml::dropDownList('Order[customer_type]', $_GET['Order']['customer_type'],  
				array(''=>'All','1'=>'Enable','0'=>'Disable',)
				), 'value'=>'$data->customer_type==1?"Enabled":"Disabled"'),

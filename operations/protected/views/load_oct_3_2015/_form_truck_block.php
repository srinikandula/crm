        ...
        <table class="table" id="table_upload_truck">
            <thead>
                ...
                <tr>
                        ...
                        <td><?php echo CHtml::dropdownlist('Truck[01][id_truck_type]', $tObj->id_truck_type, $truckTypeArray,array('onchange'=>'fntrucktypetonnes($(this).find("option:selected").text(),"01")')); ?></td>
                        <td><input placeholder="Per Load" class="price" type="text" id="Truck_01_expected_price" name="Truck[01][expected_price]"></td>
...
<script type="text/javascript">
                    ...
                    function addTruck()
                    {
                        ...
                        row += '<td><select name="Truck[' + row_no + '1][id_truck_type]" onchange="fntrucktypetonnes($(this).find(\'option:selected\').text(),\''+row_no+'1\')" ><?php echo $truck_type; ?></select></td>';
                        row += '<td><input placeholder="Per Load" type="text" class="price" id="Truck_' + row_no + '1_expected_price" name="Truck[' + row_no + '1][expected_price]" ></td>';
...
function fntrucktypetonnes(name,row){
    //alert(name+" name and row "+row);
    var str=name.split(" ");
    var msg;
    //alert(str[3]+" "+parseInt(str[parseInt(parseInt(str.length)-1)]));
    if(parseInt(str[parseInt(parseInt(str.length)-1)])>10){
        msg="Per Ton";
    }else{
        msg="Per Load";
    }
    //alert(str[parseInt(str.length)]);
    $('#Truck_'+row+'_expected_price').attr('placeholder',msg);
}

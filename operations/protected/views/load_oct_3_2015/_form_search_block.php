                ...
                <fieldset class="portlet" >
                    ...
                    <div class="portlet-content" id="hide_box_line1">
                        ...
                        <div class="span4">   <?php
                            ...
                            $model['ltr']->id_goods_type=$model['search']['id_goods_type'];
                            echo $form->dropDownListRow($model['ltr'], 'id_goods_type', $list,array('value'=>$model['search']['id_goods_type'],'name' => 'search[id_goods_type]'));
                            ?> </div>

                        <div class="span4">   <?php
                            
                            $list = CHtml::listData(Trucktype::model()->findAll(array('condition' => 'status=1 order by title asc')), 'id_truck_type', 'title');                      $model['ltr']->id_truck_type=$model['search']['id_truck_type'];
                        ...
                        <div class="span4">   <?php
                            echo $form->textFieldRow(
                                    $model['ltr'], 'tonnes', array('name' => 'search[tonnes]', 'rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)
                            );
                            ?></div>
                        <!--<div class="span5">  <?php

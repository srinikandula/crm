...
/*$this->widget(
    ...
    array(
        'type' => 'pills', 
        'tabs' => array(
            array( 'label' => 'Customer', 'active' => true ,  'content' => $this->renderPartial('_customer', array('form'=>$form,'model'=>$model),true)),
			//array( 'label' => 'Order',  'content' => $this->renderPartial('_form', array('form'=>$form,'model'=>$model),true)),

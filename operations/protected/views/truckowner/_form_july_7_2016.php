            ...
            <fieldset class="portlet">
                ...
                <div class="portlet-content" id="hide_box_line1">
                    ...
                    <div class="span5 uploading-img-main">
                        ...
                        echo '<p class="image-name-display"><a target="_blank" href="'.$this->createUrl('site/download',array('name'=>$model['c']->profile_image,'path'=>Library::getMiscUploadPath())).'">' . $model['c']->profile_image . '</a></p>';
						echo '<a target="_blank" href="'.$this->createUrl('site/download',array('name'=>$model['c']->profile_image,'path'=>'Misc')).'">' . $model['c']->profile_image . '</a>';
                        ?>
                    </div>


                    <div class="span5" id="field_ca">
                        <div class="control-group" >
                            <label for="Customer_operating_destination_city" class="control-label">Operating Routes</label>
                            <div class="controls" id="input_fields_wrap" >
                                <button class="add_field_button">+</button>
                                <?php /* if ($_GET['id'] == '') { ?>
                                  <div>
                                  <input type="text" id="Customer_operating_destination_city_1" name="Customer[operating_destination_city][]" data-placement="right" data-toggle="tooltip" rel="tooltip" data-original-title="" title="" value="<?php echo $model['cod']['0']->address ?>">
                                  </div>
                                  <?php } */ ?>
                                <?php
                                $i = 1;
                                foreach ($model['cod'] as $codObj) {
                                    ?>
                                    <div >
                                        <input type="text" placeholder="source" id="Customer_operating_source_city_<?php echo $i; ?>" name="Customer[operating_city][<?php echo $i; ?>][source]" data-placement="right" data-toggle="tooltip" rel="tooltip" data-original-title="" title="" value="<?php echo $codObj->source_address ?>">
                                        <input type="text" placeholder="destination" id="Customer_operating_destination_city_<?php echo $i; ?>" name="Customer[operating_city][<?php echo $i; ?>][destination]" data-placement="right" data-toggle="tooltip" rel="tooltip" data-original-title="" title="" value="<?php echo $codObj->destination_address ?>">
                                        <button class="remove_field" href="#">-</button>
...
?>
                    ...
                    <div class="span5">
                        <?php echo $form->dropDownListRow($model['c'], 'payment_type', Library::getPaymentTypes(), array('prompt' => 'select')); ?>
                    </div>
...
?>
                    ...
                    ?>
                        ...
                        <div class="span5">
                            <div class="control-group">
                                <label for="Customer_password" class="control-label">Rating</label>
                                <div class="controls">
...
?>
                        <table class="table_customer_doc">
                            <thead>
                                <tr>
                                    <th>Upload</th>
                                    <th>Type</th>
        ...
        ?>
                                            <td>
                                                <div class="span5 uploading-img-main">
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <input type="file" id="Customerdocs[upload][<?php echo $row; ?>][image]?>" class="Options_design" data-placement="right" data-toggle="tooltip" rel="tooltip" name="Customerdocs[upload][<?php echo $row; ?>][image]" data-original-title="Upload category logo from your computer">
                                                            <div style="display:none" id="Customerdocs[upload][<?php echo $row; ?>][image]" class="help-inline error"></div>
                                    ...
                                    <?php echo $fileRow->file; ?><img src="<?php echo Library::getMiscUploadLink() . $fileRow->file; ?>" width="200px" height="200px">
                                                    <div class="logo-img-to">
...
<?php $this->endWidget(); ?>
    ...
    <?php $this->renderPartial('/leads/_form_truck_block', array('form'=>$form,'model'=>$model));
...
<input id="ytproductimage_upload_' + row_no + '_image" type="hidden" name="Customerdocs[upload][' + row_no + '][image]" value=""></td>';
    ...
    row += '<td></td>';
            ...
            row += '</tr>';
            row += '</tbody>';
            $('.table_customer_doc tfoot').before(row);
            row_no++;
        }

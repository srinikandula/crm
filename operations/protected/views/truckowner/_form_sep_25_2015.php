<div class="row-fluid">
    ...
    ?>
           ...
           array('rel'=>'tooltip','data-toggle'=>"tooltip",'data-placement'=>"right",)
                    ...
                    <div class="span5">
                        <?php
                        echo $form->dropDownListRow($model['c'], 'payment_type', Library::getPaymentTypes(),array('prompt'=>'select'));?>
                    </div>

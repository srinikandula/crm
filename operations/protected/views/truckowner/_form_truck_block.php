...
/*$this->widget('zii.widgets.jui.CJuiDatePicker',
                                array(
                            'model' => $tObj,
                            'attribute' => 'fitness_certificate_expiry_date',
                            'name' => 'Truck[' . $row_truck . '][fitness_certificate_expiry_date]', // This is how it works for me.
                            'value' => $tObj->vehicle_insurance_expiry_date,
                ...
                foreach ($model['t'] as $tObj) {
                    ...
                    <tbody id="row1-<?php echo $row_truck; ?>">
                        <tr><td><input type="text" name="Truck[<?php echo $row_truck; ?>1][truck_reg_no]" value="<?php echo $tObj->truck_reg_no; ?>"></td>
                            ...
                            <td><input type="text" name="Truck[<?php echo $row_truck; ?>1][gps_imei_no]" value="<?php echo $tObj->gps_imei_no; ?>"></td>
                            <td><input type="text" name="Truck[<?php echo $row_truck; ?>1][gps_mobile_no]" value="<?php echo $tObj->gps_mobile_no; ?>"></td>
...
<input type="text" name="Truck[<?php echo $row_truck; ?>1][fitness_certificate_expiry_date]" class="date" value="<?php echo $tObj->fitness_certificate_expiry_date; ?>"></td>
                            <td>Vehicle Insurance<input id="Truckdoc_upload_<?php echo $row_truck; ?>1_vehicle_insurance" name="Truckdoc[upload][<?php echo $row_truck; ?>1][vehicle_insurance]" type="file"><?php echo $this->imagePopup($tObj->vehicle_insurance);?><br/>
                                Fitness Certificate<input id="Truckdoc_upload_<?php echo $row_truck; ?>1_fitness_certificate" name="Truckdoc[upload][<?php echo $row_truck; ?>1][fitness_certificate]" type="file"><?php echo $this->imagePopup($tObj->fitness_certificate);?><br/>
                               Vechile Rc <input id="Truckdoc_upload_<?php echo $row_truck; ?>1_vehicle_rc" name="Truckdoc[upload][<?php echo $row_truck; ?>1][vehicle_rc]" type="file"><?php echo $this->imagePopup($tObj->vehicle_rc);?></td>
                            <td>Front Pic:<input id="Truckdoc_upload_<?php echo $row_truck; ?>1_front_pic" name="Truckdoc[upload][<?php echo $row_truck; ?>1][front_pic]" type="file"><?php echo $this->imagePopup($tObj->front_pic);?><br/>Back Pic:<input id="Truckdoc_upload_<?php echo $row_truck; ?>1_back_pic" name="Truckdoc[upload][<?php echo $row_truck; ?>1][back_pic]" type="file"><?php echo $this->imagePopup($tObj->back_pic);?><br/>Left Pic:<input id="Truckdoc_upload_<?php echo $row_truck; ?>1_left_pic" name="Truckdoc[upload][<?php echo $row_truck; ?>1][left_pic]" type="file"><?php echo $this->imagePopup($tObj->left_pic);?><br/>Right Pic:<input id="Truckdoc_upload_<?php echo $row_truck; ?>1_right_pic" name="Truckdoc[upload][<?php echo $row_truck; ?>1][right_pic]" type="file"><?php echo $this->imagePopup($tObj->right_pic);?><br/>Top Pic<input id="Truckdoc_upload_<?php echo $row_truck; ?>1_top_pic" name="Truckdoc[upload][<?php echo $row_truck; ?>1][top_pic]" type="file"><?php echo $this->imagePopup($tObj->top_pic);?>
...
<script type="text/javascript">
    ...
    function addTruck()
    {
        ...
        row += '<td><input type="text" name="Truck[' + row_no + '1][gps_imei_no]"></td>';
        row += '<td><input type="text" name="Truck[' + row_no + '1][gps_mobile_no]"></td>';

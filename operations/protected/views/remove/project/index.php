    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
				...
				array('name' => 'id_customer', 'header' => 'Customer', 'value' => array($this,'grid')),
                array('name' => 'part_name', 'header' => 'Part Name', 'value' => '$data->part_name'),
                array('name' => 'part_number', 'header' => 'Part Number', 'value' => '$data->part_number'),
                array('name' => 'target_price', 'header' => 'Price', 'value' => '$data->target_price'),
				array('name' => 'id_supplier', 'header' => 'Supplier', 'value' => array($this,'grid')),
				array('name' => 'id_project_bidding', 'header' => 'Biddings', 'value' => array($this,'grid')),
				array('name' => 'category', 'header' => 'Category', 'value' => '$data->category'),
				array('name' => 'project_status', 'header' => 'Project Status', 'value' => '$data->project_status'),
				array('name' => 'manufacturing_status', 'header' => 'Manufacturing Status', 'value' => '$data->manufacturing_status'),
                array('name' => 'date_of_requirement', 'header' => 'Date Of Requirement', 'value' => '$data->date_of_requirement'),
                array('name' => 'status', 'header' => 'Status',
                    'filter' => CHtml::dropDownList('Project[status]',
                            $_GET['Project']['status'],

        ...
        <div class="span12">
            ...
            <div class="span2 dropdown_cut_main pull-right">
                <div class="span7 pull-right">
                    <?php Library::getPageList(array('totalItemCount' => $model->searchSupplier()->totalItemCount)); ?>
                </div>
            </div>
        </div>
    </div>
	...
	'columns'=>array(
     array(
        ...
        'value'=>'$this->grid->dataProvider->pagination->currentPage * $this->grid->dataProvider->pagination->pageSize + ($row+1)',
                ...
                array('name'=>'firstname','header'=>'Supplier Name','value'=>'$data->firstname'),
				array('name'=>'company','header'=>'Company','value'=>'$data->company'),
				array('name'=>'company_website','header'=>'Website','value'=>'$data->company_website'),

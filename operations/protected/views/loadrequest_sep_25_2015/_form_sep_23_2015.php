...
<div class="span5">  <?php echo $form->textFieldRow(
       ...
       <div class="span5">  <?php echo $form->textFieldRow(
           ...
           array('rel'=>'tooltip','data-toggle'=>"tooltip",'data-placement'=>"right",)
                    ...
                    <div class="span4">  <div class="control-group"><label for="Truckloadrequest_title" class="control-label required">Destination <span class="required">*</span></label>
                            <div class="controls">
                                <input type="text" id="Truckloadrequest_title" name="Truckloadrequest[title]" data-placement="right" data-toggle="tooltip" rel="tooltip" value="<?php echo $model['dest'];?>" data-original-title="" title="">
                                <div style="display:none" id="Truckloadrequest_title_em_" class="help-inline error"></div></div>
                                    
                        </div></div>
                     <div class="span4">  <div class="control-group"><label for="Truckloadrequest_price" class="control-label required">Price <span class="required">*</span></label>
                            <div class="controls">
...
<script src="http://maps.googleapis.com/maps/api/js?sensor=false&amp;libraries=places" type="text/javascript"></script>
    <script type='text/javascript'>
        ...
        //var input = document.getElementById('Truckloadrequest_title');
        //var autocomplete = new google.maps.places.Autocomplete(input);

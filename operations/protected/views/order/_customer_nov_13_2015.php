...
<div class="span12">
                ...
                <?php echo $this->renderPartial('_customer_right_block_billing', array('form' => $form, 'model' => $model), true);?>
                <?php echo $this->renderPartial('_customer_right_block_transactions', array('form' => $form, 'model' => $model), true);?>
                </div>
            </fieldset>

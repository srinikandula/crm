                ...
                <fieldset class="portlet" >
                    ...
                    <div id="unregistered" style="display:none" >
                        ...
                        <div class="span5">
                            ...
                            echo $form->radioButtonListRow($model['o'], 'orderperson_type', array('TR' => "Transporter", "L" => "Load Onwer"));
                            ?>
                        </div>
                    </div>
        ...
        <div >
            <div class="span6">
                <fieldset class="portlet">
                    ...
                    <div class="span5">  <?php
                        echo $form->textFieldRow(
                    $model['o'], 'load_owner_loading_charges', array( 'rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)
                    );?>
                    </div>
                    <div class="span5">  <?php
                        echo $form->textFieldRow(
                    $model['o'], 'load_owner_unloading_charges', array( 'rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)
                    );?>
                    </div>

					<div class="span5">  <?php
                        echo $form->textFieldRow(
                    $model['o'], 'load_owner_commission', array( 'rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)
                    );?>
                    </div>
            ...
            <div class="span6">
                <fieldset class="portlet">
                    <div class="portlet-decoration arrow-minus">
                        <div class="span11">Truck Owner Billing</div>
                    ...
                    <div class="span5">  <?php
                        echo $form->textFieldRow(
                    $model['o'], 'truck_owner_commission', array( 'rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)
                    );?>
                    </div>
                    <div class="span5">
                        <?php
...
echo $form->dropDownListRow($model['o'], 'id_truck_type', $list);
?>
                </div>
                <div class="span5">  <?php
                    echo $form->textFieldRow(
                ...
                <div class="span5">  <?php
                    echo $form->textFieldRow(
                            $model['o'], 'loading_agent_no', array('rel' => 'tooltip', 'data-toggle' => "tooltip", 'data-placement' => "right",)
                    );
                    ?></div>            
                <div class="span5">  <?php
                    echo $form->textFieldRow(

                ...
                <div class="portlet-content" id="hide_box_line4">
                    <table class="table uploading-status" border='0'>
                        ...
                        <tbody id="order_status">
                            ...
                            foreach (Orderhistory::model()->findAll(array("select"=>"*,DATE_FORMAT(date_created,'%d-%m-%Y %h:%i %p') as date_created",'condition' => 'id_order=' . (int) $_GET['id'], 'order' => 'date_created desc')) as $history): ?>
                                <tr>

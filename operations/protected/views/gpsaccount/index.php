    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'customer_type', 'header' => 'Customer Id', 'value' => array($this,'grid'),'type'=>'raw'),
                array('name' => 'contactName', 'header' => 'Contact Name', 'value' => '$data->contactName'),
				...
				array('name' => 'privateLabelName', 'header' => 'Alt Phone', 'value' => '$data->privateLabelName'),
				array('name' => 'contactAddress', 'header' => 'Contact Address', 'value' => '$data->contactAddress'),
                array('name' => 'password', 'header' => 'Password', 'value' => '$data->password'),
                array('name' => 'no_of_vehicles', 'header' => 'No Of Vehicles', 'type'=>'raw', 'value' => array($this,'grid'),'filter'=>false),
				array('name' => 'operating_routes_count', 'header' => 'Operating Routes','type'=>'raw', 'value' => '$data->operating_routes_count','filter'=>false),
...
<script>
function fngetDeviceDetails(id){
    //window.open("/gaadi_new/osadmin/index.php/cagent/export/id/"+id, "", "width=200, height=100,menubar=0,titlebar=0,status=0,toolbar=0");

  var w='900';
  var h='600';
  var left = (screen.width/2)-(w/2);
  var top = (screen.height/2)-(h/2);
  return window.open('<?php echo $this->createUrl("gpsaccount/getDeviceDetails");?>?accountid='+id, 'Device Details', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);

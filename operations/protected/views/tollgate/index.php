    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'source_city', 'header' => 'Source City', 'value' => '$data->source_city'),
                array('name' => 'destination_city', 'header' => 'Destination City', 'value' => '$data->destination_city'),
                array('name' => 'no_of_tollgates', 'header' => 'No of Tollgates', 'value' => '$data->no_of_tollgates'),

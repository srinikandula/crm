        ...
        <div class="span12">
            ...
            <div class="span2 dropdown_cut_main pull-right">
                <div class="span7 pull-right">
                    <?php Library::getPageList(array('totalItemCount' => $model->customerAssignment()->totalItemCount)); ?>
                </div>
            </div>
        </div>
    </div>
...
<div class="row-fluid">
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'ajaxUpdate' => false,
            'id' => 'productinfo-grid',
            'dataProvider' => $model->customerAssignment(),
            'filter' => $model,
            'bulkActions' => array(
                'actionButtons' => array(
                ),
            ...
            'columns' => array(
                ...
                array('name' => 'date_created', 'header' => 'Title', 'value' => '$data->date_created'),
                array('name' => 'id_customer', 'header' => 'Id', 'value' => '$data->id_customer'),
				array('name' => 'id_admin_created', 'header' => 'Created By', 'value' => array($this,'grid')),
				array('name' => 'id_admin_assigned', 'header' => 'Assigned To', 'value' => array($this,'grid'),'type'=>'raw'),

...
<div class="note_box">
	...
	<div class="note">Indicates Inactive User.
	</div>
</div>
...
<div class="row-fluid">
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView', array(
            ...
            'filter'=>$model,
			'rowCssClassExpression' => '( $row%2 ? $this->rowCssClass[1] : $this->rowCssClass[0] ). ($data->status==0?" alert":"")',
            'bulkActions' => array(
                'actionButtons' => array(
                ),
            ...
            'columns' => array(
                ...
                array('name' => 'id_truck_load_request', 'header' => 'LRID', 'value' => '$data->id_truck_load_request'),
		...
		//array('name' => 'make_month', 'header' => 'Make Month', 'value' => '$data->make_month'),
                ...
                array('name' => 'destination_address', 'header' => 'Destinations', 'value' => '$data->destination_address'),
                array('name' => 'price', 'header' => 'Prices', 'value' => '$data->price'),

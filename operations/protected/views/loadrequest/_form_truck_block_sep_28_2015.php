    ...
    <table class="table" id="table_upload_truck">
        <thead>
            ...
            <tr>
                ...
                <td><input placeholder="Destination 1" type="text" id="Truck_010_destination_address" name="Truck[01][destination_address][0]" ><input placeholder="Destination 2" type="text"  id="Truck_011_destination_address" name="Truck[01][destination_address][1]" ><input placeholder="Destination 3" type="text" id="Truck_012_destination_address" name="Truck[01][destination_address][2]" ></td>
                <td><input placeholder="Price 1" type="text" style="width:50px" name="Truck[01][price][0]" ><input placeholder="Price 2" style="width:50px" type="text"  name="Truck[01][price][1]" ><input placeholder="Price 3" type="text"  name="Truck[01][price][2]" style="width:50px" ></td>
                ...
                <td><select name="Truck[01][id_truck_type]"><?php echo $truck_type; ?></select></td>

    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'source', 'header' => 'Source',
                    'filter' => CHtml::dropDownList('City[source]',
                            $_GET['City']['source'],
                            array('' => 'All', '1' => 'Enable', '0' => 'Disable',)
                    ), 'value' => '$data->source==1?"Enabled":"Disabled"'),
				array('name' => 'destination', 'header' => 'destination',
                    'filter' => CHtml::dropDownList('City[destination]',
                            $_GET['City']['destination'],
                            array('' => 'All', '1' => 'Enable', '0' => 'Disable',)
                    ), 'value' => '$data->destination==1?"Enabled":"Disabled"'),

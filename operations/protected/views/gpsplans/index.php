    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'plan_name', 'header' => 'Plan Name', 'value' => '$data->plan_name'),
                array('name' => 'duration_in_months', 'header' => 'Duration', 'value' => '$data->duration_in_months'),
                array('name' => 'amount', 'header' => 'Amount', 'value' => '$data->amount'),
                array('name' => 'status', 'header' => 'Status',
                    'filter' => CHtml::dropDownList('GpsDevicePlans[status]',
                            $_GET['GpsDevicePlans']['status'],

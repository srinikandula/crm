<div class="row-fluid">
    ...
    <fieldset class="portlet " >
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            //'filter' => $model,
			'rowCssClassExpression' => '( $row%2 ? $this->rowCssClass[1] : $this->rowCssClass[0] ). ((($data[fitness_certificate_expiry_date]>=(date("Y-m-d", strtotime("-5 days")))) || ($data[vehicle_insurance_expiry_date]>=(date("Y-m-d", strtotime("-5 days")))))?" alert":"")',
            'columns' => array(
                array(
                    'header' => 'S.No',
		...
		//array('name'=>'file','header'=>"Shipping Gateway",'value'=>'$data[file]','type'=>'raw',value=>array($this,'grid')),
                array('name'=>'idprefix','header'=>"Id",'value'=>array($this,'grid'),'type'=>'raw'),

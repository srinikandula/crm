                ...
                <div class="portlet-content" id="hide_box_line1">
                    ...
                    <div class="span4">  <?php
                        ...
                        <div class="span4">  <?php
                            ...
                            ?></div>
                        <div class="span5">   <div class="control-group"><label for="Loadtruckrequest_date_required" class="control-label">Distance/System Price</label><div class="controls"><?php echo $model['info']['distance'].'['.$model['info']['system_price']['min'].'/'.$model['info']['system_price']['avg'].']';?>
</div></div></div>    
...
<?php if ($action != 'create') {  Yii::app()->runController('load/searchResults'); 

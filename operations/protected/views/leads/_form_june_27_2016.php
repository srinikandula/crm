        ...
        <div class="span12">
            <fieldset class="portlet" >
                ...
                <div class="portlet-content" id="hide_box_line1">
                    ...
                    <div class="span5">  <?php
                        echo $form->textFieldRow(
                                $model['c'], 'mobile', array('rel' => 'tooltip','onkeydown' => 'fnKeyDown("Customer_mobile")', 'data-toggle' => "tooltip", 'data-placement' => "right","title"=>"(check if record exists in dropdown,duplicates will be rejected)")
                        );
                        ?></div>

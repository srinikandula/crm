        ...
        <div class="span12 ">
            <fieldset class="portlet" >
                ...
                <div class="portlet-content" id="hide_box_line1">
                    ...
                    <div class="span5" id="field_ca" <?php if ($model['c']->type != 'C') { ?> style="display:none"<?php } ?> >  <div class="control-group"><label for="Customer_operating_destination_city" class="control-label">Operating Destination Cities</label><div class="controls" id="input_fields_wrap"><button class="add_field_button">+</button>
                                <?php if ($_GET['id'] == '') { ?>                               
                                ...
                                foreach ($model['cod'] as $codObj) {
                                    ?>
                                    <div><input type="text"  id="Customer_operating_destination_city_<?php echo $i; ?>" name="Customer[operating_destination_city][]" data-placement="right" data-toggle="tooltip" rel="tooltip" data-original-title="" title="" value="<?php echo $codObj->address ?>"></div>
    ...
    $(document).ready(function() {
        ...
        $(add_button).click(function(e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                ...
                $(wrapper).append('<div><input type="text"  id="Customer_operating_destination_city_' + x + '" name="Customer[operating_destination_city][]" data-placement="right" data-toggle="tooltip" rel="tooltip" data-original-title="" title=""><button class="remove_field" >-</button></div>'); //add input box
                //initialize();

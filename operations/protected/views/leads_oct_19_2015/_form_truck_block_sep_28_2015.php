                ...
                foreach ($model['t'] as $tObj) {
                    ...
                    <tbody id="row1-<?php echo $row_truck; ?>">
                        <tr><td><input type="text" name="Truck[<?php echo $row_truck; ?>1][truck_reg_no]" value="<?php echo $tObj->truck_reg_no; ?>"></td>
                            ...
                            <td><input type="text" name="Truck[<?php echo $row_truck; ?>1][vehicle_insurance_expiry_date]" value="<?php echo $tObj->vehicle_insurance_expiry_date; ?>"></td>
                            <td><input type="text" name="Truck[<?php echo $row_truck; ?>1][fitness_certificate_expiry_date]" value="<?php echo $tObj->fitness_certificate_expiry_date; ?>"></td>
...
<script type="text/javascript">
    ...
    function addTruck()
    {
        ...
        row += '<td><input type="text" name="Truck[' + row_no + '1][vehicle_insurance_expiry_date]"></td>';
        row += '<td><input type="text" name="Truck[' + row_no + '1][fitness_certificate_expiry_date]"></td>';

    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'date_ordered', 'header' => 'Date Created', 'value' => '$data->date_ordered'),
                array('name' => 'id_order', 'header' => 'Id', 'value' => '$data->id_order'),
...
function fnchange(field,id){
    $.ajax({
				url: '<?php  echo $this->createUrl("oassign/update");?>',
				dataType: 'json',

    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'fullname', 'header' => 'Full Name', 'value' => '$data->fullname'),
                array('name' => 'account', 'header' => 'Account', 'value' => '$data->account'),
                array('name' => 'mobile', 'header' => 'Mobile', 'value' => '$data->mobile'),
				array('name' => 'landline', 'header' => 'Landline', 'value' => '$data->landline'),
				array('name' => 'doj', 'header' => 'DOJ', 'value' => '$data->doj'),
